...
export function writeAuthorLatexFile(meta, distDir) {
    ...
    writeFileSync(abs, ['% Auto-generated by src/build.ts - do not edit', body, ''].join('\n'), 'utf-8');
    return abs;
}
...
function footerLeftLine(meta) {
    if (meta.footerLeft === undefined)
        return footCell('L', '\\footnotesize \\today');
    if (meta.footerLeft === '')
        return footCell('L', '');
...
export function writeBuildLatexIncludes(meta, distDir, srcDir, fontsRelToRoot) {
    const latexStyle = join(srcDir, 'latex-style.tex').replace(/\\/g, '/');
    const fonts = fontsRelToRoot.replace(/\\/g, '/');
    const fancy = [
        '% Auto-generated by src/build.ts - do not edit',
        '\\usepackage{fancyhdr}',
